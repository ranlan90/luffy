...
let  vm = new Vue();
// 设置公共的url
Axios.defaults.baseURL = 'http://122.51.145.16:8000';
...
export const  userReg = (params)=>{
	// 这个参数至少有五个字段 username password  验证的三个字段
	return Axios.post('http://127.0.0.1:8000/reg/',params).then(res=>res);
};
...
// 更新购物车数据
export const shoppingcarUpdate = (params)=>{
  return Axios.put(`http://127.0.0.1:8000/shoppingcar/`,params).then(res=>res.data);
}
// 退出
export const logout = ()=>{
