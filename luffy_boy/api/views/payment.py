        ...
        try:
            ...
            for course_dict in course_list:
                ...
                if coupon_record_id:
                    ...
                    coupon_record_list.append(coupon_record_id)
            ...
            if global_coupon_id:
                global_coupon_record_obj = CouponRecord.objects.get(pk=global_coupon_id)
                global_coupon_record_obj.order_id=order_obj.id
                global_coupon_record_obj.save()
            order_obj.couponrecord_set.set(coupon_record_list)
