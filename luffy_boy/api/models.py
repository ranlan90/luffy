...
class Order(models.Model):
    ...
    # coupon = models.OneToOneField("CouponRecord", blank=True, null=True, verbose_name="优惠码") #一个订单可以有多个优惠券
...
class UserInfo(AbstractUser):
    ...
    uid = models.CharField(max_length=128, unique=True)  # 与第3方交互用户信息时，用这个uid,以避免泄露敏感用户信息
